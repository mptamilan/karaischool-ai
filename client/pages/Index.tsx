        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6 pt-12 md:pt-20 pb-12 md:pb-20 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-slate-600 text-lg md:text-xl max-w-xl">
              Your intelligent study companion. Ask questions, get instant
              explanations, and learn faster with our AI tutor designed for
              school success.
            </p>
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 md:px-6 pb-16">
        <div className="grid md:grid-cols-3 gap-6">
          <Feature
            ...
            desc="Clear, concise answers with examples, steps, and references using Gemini 2.0 Flash."
          />
          <Feature
            icon={<MessageCircle className="h-6 w-6" />}
            title="Real-time Chat"
            desc="Smooth, mobile-first chat with Markdown, code blocks, and quick examples."
          />
          <Feature
